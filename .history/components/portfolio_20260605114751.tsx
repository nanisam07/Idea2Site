...
export default function Portfolio() {
  ...
  className="project-card group relative rounded-2xl overflow-hidden bg-white/5 dark:bg-white/5 light:bg-slate-900/5 backdrop-blur-sm border border-white/10 dark:border-white/10 light:border-slate-900/10 hover:border-cyan-400/50 transition-all duration-300 cursor-pointer"
>
